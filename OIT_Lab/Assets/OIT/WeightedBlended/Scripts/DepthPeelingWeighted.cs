...
public class DepthPDepthPeelingWeightedeelingManager : MonoBehaviour {
    ...
    struct OITdata {
        ...
        RenderTexture[] depths;
        RenderTexture[] transmittance;
    }
    ...
    //          ushort2 tid)
    //{
    //    threadgroup_imageblock OITData<NUM_LAYERS> &pixelData = oitData.data(tid)->oitData; //threadgroup_imageblock address space
